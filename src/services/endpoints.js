const endPoints = {
    ...
    GET_UPCOMING_MEETINGS:({pageNo,items})=>'/meeting/getUpCommingMeetings'+`?pageNo=${pageNo}&items=${items}`,
    GET_PENDING_MEETINGS:({pageNo,items})=>'/meeting/getPendingMeetings'+`?pageNo=${pageNo}&items=${items}`,
}
