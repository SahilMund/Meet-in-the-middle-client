...
export const getUpcomingMeetings = (data) => axios.get(endPoints.GET_UPCOMING_MEETINGS(data));
export const getPendingMeetings = (data) => axios.get(endPoints.GET_PENDING_MEETINGS(data));