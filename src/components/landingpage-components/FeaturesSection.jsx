...
const FeaturesSection = () => {
    ...
    const features=[
        {
            ...
            description:"our algorithm finds the perfect meeting spot equidistant from all participants"
        },
        {
            icon:<BsFillPeopleFill  className="text-4xl text-[#FF4C61]" />,
            heading:"Easy Collaboration",
            description:"Invite participants, share locations and vote on the best meeting places"
        },
          {
            icon:<MdOutlineAccessTime  className="text-4xl text-[#FF4C61]"/>,
            heading:"Real Time Updates",
            description:"Get instant notifications about meeting changes and participant responses"
        },
          {
            icon:<GoGlobe  className="text-4xl text-[#FF4C61]"/>,
            heading:"Global Coverage",
            description:"Works anywhere in the world with comprehensive location data"
        },
          {
 ...
 <div className="py-12 px-6 bg-gray-50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        >
            <motion.div className="mb-4 p-4  rounded-full">{item.icon}</motion.div>
